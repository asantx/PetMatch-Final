  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-edit"></i> UPDATE PETS</h4>
      </div>
...
<div class="col-lg-2">
  ...
  <div class="col-lg-2">
    ...
    <input type="number" class="form-control" id="prize" name="prizw" placeholder="Donation Fee" value="<?php echo $quantity;?>" required>
