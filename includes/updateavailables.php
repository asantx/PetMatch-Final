        ...
        <div class="panel panel-primary">
            <div class="panel-heading panel-title text-center wow fadeInDown">
                <span style="font-weight:bold; font-family:verdana;"><i class="glyphicon glyphicon-list-alt"></i> Pet List 🐶</span>
            </div>
            <div class="panel-body" style="background-color:#fff;">
              ...
              <table class="table table-responsive table-hover table-bordered table-condensed table-striped wow fadeInDown" width="100%">
              	<thead>
					...
					$id = 0;
					$sql = ("SELECT *  FROM pet order by id DESC") or die (mysqli_error());
					...
					if(mysqli_num_rows($result)>0){
                    	...
                    	<tr style="font-size:16px; cursor:pointer;">
                            ...
                            <td class="wow fadeInDown"> <center><img src="<?php echo $row['image'];?>" width="300px;" class="img-responsive img-rounded" /></center></td>
                            <td class="wow fadeInDown"><center><a href="#updateModal<?php echo $id;?>" data-toggle="modal" data-target="#updateModal<?php echo $id;?>" class="btn btn-default">Update</a> <br><br>  <a href="#deleteModal<?php echo $id;?>" data-toggle="modal" data-target="#deleteModal<?php echo $id;?>" class="btn btn-danger">Delete</a></center></td>
                        </tr>
